    ...
    return (
        <footer className="w-full pb-5 mb-[100px] md:mb-5" id="contact">
            <div className="flex flex-col items-center">
                ...
                <p className="text-white-300 md:mt-10 my-5 text-center">Reach Out to me Your Goal. I Can Help you</p>
            <a href="mailTo:harshakumara1998030944@gmail.com">
                ...
                <div>
                   <div className="flex flex-col md:flex-row mt-16 justify-between items-center">
                        <p className="md:text-base font-light md:font-normal">Copyright © 2025 Piyumi</p>
